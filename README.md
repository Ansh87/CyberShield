...
The Intel tab lists the most recent additions to the catalog fifteen at a time. The refresh button pages forward through them, and wrapping past the end refetches.
